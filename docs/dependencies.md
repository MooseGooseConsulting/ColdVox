...
- **STT**: the supported Windows live path is the Parakeet HTTP container profile. `pyo3` remains in the tree for older Moonshine-related paths, but it is not the primary Windows validation path.
